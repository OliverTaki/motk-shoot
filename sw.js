...
const ASSETS = [
  ...
  'js/xsheet.js', 'js/export.js', 'js/editorial.js', 'js/ae-roundtrip.js', 'js/project.js', 'js/production.js', 'js/cinematography.js', 'js/faces.js', 'js/review.js', 'js/tether.js',
